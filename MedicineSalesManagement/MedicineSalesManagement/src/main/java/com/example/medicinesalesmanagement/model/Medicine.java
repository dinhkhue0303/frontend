...
public class Medicine {
    ...
    public Medicine(Integer id_medicine, String name, String unit, double price, int quantity, LocalDateTime productionDate, LocalDateTime expirationDate, Employee employee, List<InputWarehouse> inputWarehouseList) {
